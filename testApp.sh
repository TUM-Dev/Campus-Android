...
./gradlew assembleDebugAndroidTest && 
	...
	adb shell am instrument -w -r -e package de.tum.in.tumcampusapp -e debug false de.tum.in.tumcampusapp.test/android.support.test.runner.AndroidJUnitRunner --no-window-animation
