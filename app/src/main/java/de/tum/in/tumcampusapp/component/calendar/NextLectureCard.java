package de.tum.in.tumcampusapp.component.calendar;
...
public class NextLectureCard extends NotificationAwareCard {
    ...
    public void setLectures(List<de.tum.in.tumcampusapp.component.calendar.model.CalendarItem> calendarItems) {
        for (de.tum.in.tumcampusapp.component.calendar.model.CalendarItem calendarItem : calendarItems) {
