...
import de.tum.`in`.tumcampusapp.component.ui.ticket.EventActivity
...
class DrawerMenuHelper(private val mContext: Context, private val mDrawerLayout: DrawerLayout) : NavigationView.OnNavigationItemSelectedListener {
    ...
    companion object {
        ...
        private val COMMON_TUM = arrayOf(
                ...
                SideNavigationItem(R.string.events, R.drawable.ic_time, EventActivity::class.java, false, false)
        )
