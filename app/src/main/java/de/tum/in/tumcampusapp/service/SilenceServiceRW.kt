...
class SilenceServiceRW(appContext: Context, workerParams: WorkerParameters):
    ...
    override fun doWork(): Result {
        ...
        val newIntent = Intent(applicationContext, SilenceServiceRW::class.java)
    ...
    companion object {
        ...
        @JvmStatic fun enqueueWork(context: Context) {
            ...
            val silenceWorkRequest = OneTimeWorkRequestBuilder<SilenceServiceRW>().build()
