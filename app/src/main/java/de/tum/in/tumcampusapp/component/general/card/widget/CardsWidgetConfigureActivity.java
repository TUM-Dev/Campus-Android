package de.tum.in.tumcampusapp.component.general.card.widget;
...
public class CardsWidgetConfigureActivity extends Activity {
    ...
    public static final String PREFS_NAME = "de.tum.in.tumcampusapp.component.general.card.widget.CardsWidget";
