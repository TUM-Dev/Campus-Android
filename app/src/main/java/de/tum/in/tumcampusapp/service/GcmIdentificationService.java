...
public class GcmIdentificationService extends FirebaseInstanceIdService {
    ...
    public void checkSetup() {
        ...
        if (token.isEmpty()) {
            ...
            // If the regId is not empty, we still need to check whether it was successfully sent to the TCA server,
            // because this can fail due to user not confirming their private key
