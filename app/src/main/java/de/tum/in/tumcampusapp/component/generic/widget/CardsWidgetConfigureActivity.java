package de.tum.in.tumcampusapp.component.generic.widget;
...
public class CardsWidgetConfigureActivity extends Activity {
    ...
    public static final String PREFS_NAME = "de.tum.in.tumcampusapp.component.generic.widget.CardsWidget";
