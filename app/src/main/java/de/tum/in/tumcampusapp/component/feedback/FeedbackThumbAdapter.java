package de.tum.in.tumcampusapp.component.feedback;
...
public class FeedbackThumbAdapter extends RecyclerView.Adapter<FeedbackThumbAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(view -> {
            ...
            LinearLayout layout = (LinearLayout)LayoutInflater.from(view.getContext()).inflate(R.layout.picture_dialog, null);
    ...
    private Bitmap createThumb(ImageView mImageView, int position){
        ...
        int targetSize = (int) mImageView.getContext().getResources().getDimension(R.dimen.thumb_size);
