...
class EventDiffUtil(
    ...
    override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int) = oldItems[oldItemPosition].getIdForComparison() == newItems[newItemPosition].getIdForComparison()
