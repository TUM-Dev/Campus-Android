...
/*
   ...
   /* public static String getDisplayedDatetime(long startMillis, long endMillis, long currentMillis,
        ...
        if (allDay) {
            ...
            if (singleDayEvent(startMillis, endMillis, currentTime.gmtoff)) {
                // Format the time.
                String timeString = DayUtils.formatDateRange(context, startMillis, endMillis,
                        flagsTime);
                ...
                if (TODAY == todayOrTomorrow) {
                    ...
                    String dateString = DayUtils.formatDateRange(context, startMillis, endMillis,
                            flagsDate);
                ...
                datetimeString = DayUtils.formatDateRange(context, startMillis, endMillis,
                        flagsDatetime);
            }
        }
    ...
    public static boolean isEmailableFrom(String email, String syncAccountName) {
        return DayUtils.isValidEmail(email) && !email.equals(syncAccountName);
    }
   ...
   /* public static String[] getQuickResponses(Context context) {
        String[] s = DayUtils.getSharedPreference(context, KEY_QUICK_RESPONSES, (String[]) null);
