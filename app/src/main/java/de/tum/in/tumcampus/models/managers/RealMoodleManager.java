...
public class RealMoodleManager extends MoodleManager {
     ...
     */
    private class GenericMoodleRequestAsyncTask extends AsyncTask<Void, Void, MoodleAPICommand> {
        ...
        @Override
        protected MoodleAPICommand doInBackground(Void... params) {
        ...
        @Override
        protected void onPostExecute(MoodleAPICommand o) {
