...
public class MVVJsoupParser extends AsyncTask<String, Void, MVVObject> {
    ...
    private static final String baseURL1 = "http://www.mvg-live.de/ims/dfiStaticAuswahl.svc?haltestelle=";
    private static final String baseURL2 = "&ubahn=checked&bus=checked&tram=checked&sbahn=checked";
    ...
    private String prepareURL(String query) {
        ...
        if (query.contains("http://www.mvg-live.de"))
            return query;
        try {
