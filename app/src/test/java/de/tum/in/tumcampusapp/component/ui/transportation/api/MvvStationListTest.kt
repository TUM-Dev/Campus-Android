...
class MvvStationListTest {
    ...
    @Test
    fun testEmptyValue() {
        val (departureList) = gson.fromJson(emptyResultExample, MvvStationList::class.java)
        Assert.assertEquals(0, departureList.size)
    }

    @Test
    fun testSingletonValue() {
        val (departureList) = gson.fromJson(singletonResultExample, MvvStationList::class.java)
        Assert.assertEquals(1, departureList.size)
        val (station, id) = departureList[0]
        Assert.assertEquals("Garching (b München), Garching, Forschungszentrum", station)
        Assert.assertEquals("1000460", id)
    }

    @Test
    fun testMultiValue() {
        val (departureList) = gson.fromJson(multiValueResultExample, MvvStationList::class.java)
        Assert.assertEquals(9, departureList.size)
    }

    companion object {

        private val emptyResultExample = "{ \"parameters\": [ { \"name\":\"serverID\", \"value\":\"WEB3_\" }, { \"name\":\"requestID\", \"value\":\"0\" }, { \"name\":\"sessionID\", \"value\":\"0\" }, { \"name\":\"calcTime\", \"value\":\"31.622\" } ], \"stopFinder\": { \"message\": [ { \"name\":\"code\", \"value\":\"-8020\" }, { \"name\":\"error\", \"value\":\"\" }, { \"name\":\"type\", \"value\":\"\" }, { \"name\":\"module\", \"value\":\"BROKER\" } ], \"input\": { \"input\":\"0000000000000000000000000000\" }, " +
                "\"points\": null " +
                "} }"

        private val singletonResultExample = "{ \"parameters\": [ { \"name\":\"serverID\", \"value\":\"WEB3_\" }, { \"name\":\"requestID\", \"value\":\"0\" }, { \"name\":\"sessionID\", \"value\":\"0\" }, { \"name\":\"calcTime\", \"value\":\"57.516\" } ], \"stopFinder\": { \"message\": [ { \"name\":\"code\", \"value\":\"-8010\" }, { \"name\":\"error\", \"value\":\"\" }, { \"name\":\"type\", \"value\":\"\" }, { \"name\":\"module\", \"value\":\"BROKER\" } ], \"input\": { \"input\":\"Garching, Forschungszentrum\" }, " +
                "\"points\": {" +
