...
class CalendarDaoTest {
    ...
    fun getNextDaysAll() {
        ...
        val from = DateUtils.getDateTimeString(now.minusDays(4)
                .toDate())
        val to = DateUtils.getDateTimeString(now.plusDays(4)
                .toDate())
    ...
    fun getNextDaysSomeOutOfDateRange() {
        ...
        val from = DateUtils.getDateTimeString(now.minusDays(2)
                .toDate())
        val to = DateUtils.getDateTimeString(now.plusDays(2)
                .toDate())
