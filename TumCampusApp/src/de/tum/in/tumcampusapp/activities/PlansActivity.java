...
public class PlansActivity extends Activity implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listMenuEntrySet.add(new ListMenuEntry(R.drawable.plan_campus_olympiapark_hallenplan_icon, R.string.campus_olympiapark_gyms,
		...
		listMenuEntrySet.add(new ListMenuEntry(R.drawable.plan_campus_weihenstephan_icon, R.string.campus_weihenstephan, R.string.campus_weihenstephan_adress,
				null));
		...
		StartListAdapter adapter = new StartListAdapter(this, R.layout.list_layout_complex_small, listMenuEntrySet, false);
