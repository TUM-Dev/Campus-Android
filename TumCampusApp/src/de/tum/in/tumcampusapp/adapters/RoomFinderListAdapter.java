...
public class RoomFinderListAdapter extends BaseAdapter {
	static class ViewHolder {
	 ...
	 private Activity activity;
	    ...
	    public RoomFinderListAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
	        activity = a;
	        data=d;
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        ...
	        roomTitle.setText(room.get(TUMRoomFinderRequest.KEY_Room + TUMRoomFinderRequest.KEY_TITLE));
	        buildingTitle.setText(room.get(TUMRoomFinderRequest.KEY_Building + TUMRoomFinderRequest.KEY_TITLE));
	        campusTitle.setText(room.get(TUMRoomFinderRequest.KEY_Campus + TUMRoomFinderRequest.KEY_TITLE));
	        return vi;
	    }
}
